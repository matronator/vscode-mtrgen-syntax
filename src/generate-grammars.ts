...
const HOST_LANGUAGE_SPECS: readonly HostLanguageSpec[] = [
    ...
    { id: "perl", displayName: "Perl", grammarScopeName: "source.mtrgen.perl", hostScopeName: "source.perl" },
    {
        ...
        grammarScopeName: "source.mtrgen.objective-c",
        hostScopeName: "source.objc",
    },
    ...
    { id: "ocaml", displayName: "OCaml", grammarScopeName: "source.mtrgen.ocaml", hostScopeName: "source.ocaml" },
    {
        ...
        grammarScopeName: "source.mtrgen.powershell",
        hostScopeName: "source.powershell",
    },
...
function createScopedInjectionSelector(rootScopeName: string, hostScopeNames: readonly string[]): string {
...
writeJson(
    ...
    createInjectionGrammar(
        "mtrgen.injection.javascript",
        createScopedInjectionSelector("source.mtrgen.javascript", ["source.js"]),
    ),
);
...
writeJson(
    ...
    createInjectionGrammar(
        "mtrgen.injection.javascriptreact",
        createScopedInjectionSelector("source.mtrgen.javascriptreact", ["source.js.jsx"]),
    ),
);
...
writeJson(
    ...
    createInjectionGrammar(
        "mtrgen.injection.typescript",
        createScopedInjectionSelector("source.mtrgen.typescript", ["source.ts"]),
    ),
);
...
writeJson(
    ...
    createInjectionGrammar(
        "mtrgen.injection.typescriptreact",
        createScopedInjectionSelector("source.mtrgen.typescriptreact", ["source.tsx"]),
    ),
);
